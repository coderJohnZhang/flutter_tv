...
class Page0WidgetState extends State<Page0Widget>
  ...
  void initState() {
    ...
    print("page0 initState() rect = " + rect.toString());
    rectAnimation =
  ...
  void _doFocusAnimation(GlobalKey key, Size newSize) {
    ...
    print('page0 _doFocusAnimation objCoordinates = $objCoordinates');
    ...
    print("page0 _doFocusAnimation rect = " +
        rect.toString() +
        " newRect = " +
        newRect.toString());
    rectAnimation =
